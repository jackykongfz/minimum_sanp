 ...
 * Return Type  : void
 */
void minSnap_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                 *plhs[10])
{
...
/*
 * File trailer for _coder_minSnap_api.c
 *
 * [EOF]
 */
